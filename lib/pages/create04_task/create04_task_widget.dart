...
class _Create04TaskWidgetState extends State<Create04TaskWidget> {
  ...
  void initState() {
    ...
    _model.assigntoTextController ??= TextEditingController();
    _model.assigntoFocusNode ??= FocusNode();
  }
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    controller: _model.assigntoTextController,
                                    focusNode: _model.assigntoFocusNode,
                                    autofocus: true,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model
                                        .assigntoTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ]
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await TasksTable().insert({
                          ...
                          'assigned_to': _model.assigntoTextController.text,
                        ...
                        setState(() {
                          _model.assigntoTextController?.clear();
