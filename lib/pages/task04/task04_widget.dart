...
import 'task04_model.dart';
export 'task04_model.dart';

class Task04Widget extends StatefulWidget {
  const Task04Widget({super.key});

  @override
  State<Task04Widget> createState() => _Task04WidgetState();
}

class _Task04WidgetState extends State<Task04Widget> {
  late Task04Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Task04Model());
                                                  ...
                                                  child: ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.network(
                                                      'https://images.unsplash.com/photo-1640951613773-54706e06851d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxMnx8dXNlcnxlbnwwfHx8fDE3MjE3MjAzMzB8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                                      width: 120.0,
                                                      height: 120.0,
                                                      fit: BoxFit.cover,
                                                    ),
